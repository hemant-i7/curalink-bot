    ...
    <div className="min-h-screen bg-gradient-to-b from-[#f8f9ff] to-[#f1f5ff]">
      ...
      <div className="relative overflow-hidden py-12">
        ...
        <div className="relative max-w-6xl mx-auto px-4 sm:px-6 flex flex-col items-center text-center z-10">
          <h1 className={cn("text-4xl font-bold tracking-tight mb-6", montserrat.className)}>
            <span className="text-[#5C5FFF] drop-shadow-[0_0_8px_rgba(92,95,255,0.2)]">Health</span>
            <span className="text-[#FF647C] drop-shadow-[0_0_8px_rgba(255,100,124,0.2)]"> Consultant</span>
            <span className="text-[#00C2D1] drop-shadow-[0_0_8px_rgba(0,194,209,0.2)]"> AI</span>
          </h1>
          <p className="text-xl text-slate-700 max-w-2xl">Connect with your AI Health Consultant through a live phone conversation for personalized medical guidance and health support.</p>
        </div>
      </div>
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 py-8">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <Card className="bg-white shadow-lg border-0 hover:shadow-xl transition-shadow duration-300 rounded-2xl border-2 border-[#151616] shadow-[4px_4px_0px_0px_#151616]">
            <CardHeader className="bg-[#5C5FFF] text-white rounded-t-2xl border-2 border-[#151616] border-b-0">
            ...
            <CardFooter className="border-t bg-gray-50 text-sm text-gray-500 rounded-b-2xl">
          ...
          {/* How it works card */}
          <Card className="bg-white shadow-lg border-0 hover:shadow-xl transition-shadow duration-300 rounded-2xl border-2 border-[#151616] shadow-[4px_4px_0px_0px_#151616]">
            <CardHeader className="bg-[#FF647C] text-white rounded-t-2xl border-2 border-[#151616] border-b-0">
              <CardTitle className="flex items-center gap-2 font-bold">
            ...
            <CardContent className="pt-6">
              <div className="space-y-4">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h3 className="font-medium">Receive AI Health Call</h3>
                    <p className="text-sm text-gray-500">Our AI Health Consultant will call you within seconds</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h3 className="font-medium">Discuss Your Health</h3>
                    <p className="text-sm text-gray-500">Speak naturally about your health concerns and get expert guidance</p>
                  </div>
                </div>
              </div>
            </CardContent>
            <CardFooter className="border-t bg-gray-50 rounded-b-2xl">
              <div className="w-full flex justify-end">
                <a href="#health-features" className="text-[#5C5FFF] hover:text-[#5C5FFF]/80 font-medium flex items-center gap-1 text-sm">
        ...
        <section id="health-features" className="py-16">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-slate-900 mb-4">AI Health Consultation Features</h2>
